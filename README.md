...
A separate platform rating system for Rapido rider partners, integrated with the existing **[GigFolio](https://github.com/dhruvilrpatil/GigFolio)** architecture.

**[Live Demo →](https://dhruvilrpatil.github.io/rapido-mockup/)**
